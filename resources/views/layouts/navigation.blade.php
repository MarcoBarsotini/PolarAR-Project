        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="font_100 text-white">
                        Home
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @if (Auth::user()->user_isAdmin === 'true')
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" style="border: 1px solid red; margin-right: 15px !important;">
                            <x-nav-link class="text-red" :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                                {{ __('ADMINISTRADOR') }}
                            </x-nav-link>
                        </div>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                @auth
                    @if (Auth::user()->user_isAdmin === 'true')
                        <x-responsive-nav-link :href="route('admin.dashboard')" style="color: red !important;">
                            {{ __('Admin') }}
                        </x-responsive-nav-link>
                    @endif
                @endauth
