<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Tenha certeza que sua senha é confiável, mantenha-se seguro.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            <x-primary-button style="background-color: #2052f7 !important; border: 1px solid #2052f7 !important;">{{ __('Save') }}</x-primary-button>
