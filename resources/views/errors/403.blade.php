...
<body>
    ...
    <div><p>> <span>CÓDIGO DE ERRO</span>: "<i>HTTP 403 Forbidden</i>"</p>
        <p>> <span>DESCRIÇÃO</span>: "<i>ACESSO NEGADO. VOCÊ NÃO TEM PERMISSÇÃO PARA ACESSAR ESSA PÁGINA</i>"</p>
        <p>> <span><a href="{{route('dashboard')}}">Clique para voltar ao início</a></span></p>
    </div>
